...
%define install_root        /opt/ingrid/ingrid-geo-api
%define target              %{buildroot}%{install_root}
%define systemd_dir         /usr/lib/systemd/system
%define ingrid_unit_name    ingrid-geo-api.service
...
# system.
if [ -f "/etc/systemd/system/ingrid-geo-api.service" ]; then
  service ingrid-geo-api stop
fi
